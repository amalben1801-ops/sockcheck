...
3. Open **http://127.0.0.1:5000** in Chrome or Edge. Do not double-click the HTML files; Flask must render them. The cinematic welcome image appears for about four seconds and then opens the detector automatically. There is no username or password.
